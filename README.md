[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=21323239)
﻿# generics

[![.NET CI/CD Pipeline](https://github.com/oop-jccc/generics/actions/workflows/ci.yml/badge.svg)](https://github.com/oop-jccc/generics/actions/workflows/ci.yml)
...
3. **Restore Dependencies:**
   ```bash
   dotnet restore Generics\GenericsTests\GenericsTests.csproj
   ```
...
```
GenericsTests/
â”œâ”€â”€ GenericsTests.csproj    # Project configuration
